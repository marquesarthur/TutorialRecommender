...
public class DependencyClassifier {
	...
	public static void trainTutorialStat(Tutorial tutorial) {

		List<CLTDependency> alldeps = extractDeps(tutorial);

		trainDepStat(tutorial, alldeps);
		trainRelStat(tutorial, alldeps);
	}
